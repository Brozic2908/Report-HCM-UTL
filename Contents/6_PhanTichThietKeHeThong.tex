...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{Images/Usecase tổng quan.png}
...
\textbf{Mô tả} & 
Cho phép người dùng quan sát dữ liệu giao thông dưới dạng biểu đồ như: biểu đồ thời gian, biểu đồ phân phối, heatmap, hoặc biểu đồ so sánh nhằm hỗ trợ việc phân tích. \\ \hline

\textbf{Tác nhân} & Người dùng. \\ \hline

\textbf{Điều kiện kích hoạt} & 
Người dùng yêu cầu xem dữ liệu ở dạng biểu đồ. \\ \hline
...
4. Biểu đồ được hiển thị cho người dùng xem hoặc lưu lại. \\ \hline
...
\textbf{Điều kiện sau hành động} &
Hiển thị bản đồ với các tuyến đường được tô màu theo giá trị tương ứng; người dùng có thể quan sát và ghi nhận kết quả. \\ \hline
...
\textbf{Mô tả} & 
Cho phép người dùng xuất các kết quả phân tích (biểu đồ, bảng số liệu, bản đồ, thống kê) thành tệp tin như PDF, CSV hoặc hình ảnh phục vụ trình bày hoặc báo cáo nghiên cứu. \\ \hline
...
\textbf{Mô tả} & 
Cho phép người dùng xem dự báo việc một nút giao thông bị tắc nghẽn sẽ ảnh hưởng và lan truyền đến các nút giao thông lân cận nào trong mạng lưới giao thông. \\ \hline
...
\textbf{Điều kiện tiên quyết} &
Dữ liệu giao thông đã được thu thập và tiền xử lý. Mạng lưới giao thông đã được xây dựng. \\ \hline

\textbf{Điều kiện sau hành động} &
Kết quả dự báo được tạo ra, bao gồm danh sách các nút bị ảnh hưởng. \\ \hline

\textbf{Luồng chính} &
1. Người dùng chọn nút giao thông cần dự báo. \newline
2. Hệ thống truy xuất dữ liệu giao thông và cấu trúc mạng lưới liên quan. \newline
3. Hệ thống thực hiện mô phỏng hoặc mô hình dự báo lan truyền ùn tắc. \newline
4. Hệ thống xác định các nút giao thông bị ảnh hưởng. \newline
5. Kết quả dự báo được hiển thị dưới dạng bản đồ, biểu đồ hoặc bảng số liệu. \\ \hline

\textbf{Luồng rẽ nhánh} &
4a. Nếu dữ liệu không đủ hoặc mô hình không hội tụ, hệ thống hiển thị thông báo lỗi hoặc cảnh báo độ tin cậy thấp. \\ \hline

\textbf{Kết quả} &
Người dùng quan sát được phạm vi lan truyền ùn tắc, hoặc nhận thông báo nếu dự báo không khả thi. \\ \hline
\end{tabular}
\end{table}
...
Dưới đây là sơ đồ thực thể-quan hệ dùng để mô tả tệp mẫu dữ liệu đầu vào của hệ thống.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Images/ERD.png}
    \caption{ERD biểu diễn cho dữ liệu đầu vào mẫu}
\end{figure}