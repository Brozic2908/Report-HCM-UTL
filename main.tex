...
\begin{tabular}{rl}
    \textbf{Hội đồng:} & 11L Đồ án tốt nghiệp \\
    ...
    \textbf{SVTH 2:} & Nguyễn Minh Khang (2211452) \\
    \textbf{SVTH 3:}: & Nguyễn Hữu Khánh (2211521)
...
\begin{center}
    \fontsize{15}{12}\selectfont TP. HỒ CHÍ MINH, THÁNG 4/2026
\end{center}
\end{titlepage}
...
%%%%%%%%%%%%%%%%%CONTENTS%%%%%%%%%%%%%%%%%%%
\input{Contents/1_GioiThieu}
\newpage
\input{Contents/2_1_CoSoLyThuyet}
\input{Contents/2_2_CongNghe}
\newpage
\input{Contents/3_CongTrinhLienQuan}
\newpage
\input{Contents/4_PhuongPhapGiaiQuyet}
\newpage
\input{Contents/5_YeuCauHeThong}
\newpage
\input{Contents/6_PhanTichThietKeHeThong}
\newpage
% \input{Contents/7_HienThucVaKiemThu}
% \newpage
% \input{Contents/8_DanhGiaHeThong}
% \newpage
\input{Contents/9_TongKet}
\newpage
\input{Contents/10_KeHoachDATN}
\newpage
%%%%%%%%%%%%%%%%%OUTRO%%%%%%%%%%%%%%%%%%%
